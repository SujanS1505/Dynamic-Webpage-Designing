...
import {
    ...
    Home, Info, Layers, FolderOpen, Users, Building2, Smile, Settings, Eye, BookOpen, Shield,
    type LucideIcon,
} from 'lucide-react';
...
const NAV_LINKS: { label: string; href: string; path: string; num: string; desc: string; icon: LucideIcon; subItems?: { label: string; path: string }[] }[] = [
    ...
    { label: 'Secure AI', href: '#secure-ai', path: '/secure-ai-playground', num: '11', desc: 'AI security workbench', icon: Shield },
